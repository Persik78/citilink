...
def test_buy_processor_amd_ryzen_7_7700(set_up):
    ...
    time.sleep(1) # Фильтры чем то перекрыты, не получалось через явное ожидание и обычный клик по чек боксу. У меня всегда успевали фильтры подгружатья, добавил на всякий случай
