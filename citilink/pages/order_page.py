...
class OrderPage(Base):
    ...
    def get_price_delivery(self):
        return WebDriverWait(self.driver, 30).until(EC.element_to_be_clickable((By.XPATH, self.price_delivery)))
    ...
    def check_place_an_order(self):
        self.get_place_an_order()
    ...
    def entry_recipients_details(self):
        ...
        self.input_first_name('Test first name')
        self.input_last_name('Test last name')
        self.input_phone_number('9999999999')
        self.get_screenshot('entry_recipients_details')

    def select_receipt_and_payment_delivery(self):
        self.click_delivery()
        self.input_street('Test Street')
        self.click_add_street()
        self.input_building('D44')
        self.input_email('testMail@mail.com')
        self.get_screenshot('select_receipt_and_payment_delivery')
        self.assert_total_cost(self.int_total_cost_order() + self.int_price_delivery(), 19990 + self.int_price_delivery())
